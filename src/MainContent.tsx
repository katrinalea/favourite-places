...
const PlacesArr: PlacesLayout[] = [
  {
    image:
      "https://th.bing.com/th/id/OIP.SeThF0lWfP3Uov18F2r7bgHaE8?w=260&h=180&c=7&r=0&o=5&pid=1.7",
    place: "Iguazu Falls",
  ...
  {
    image:
      "https://www.bing.com/th?id=OIP.z9zYsN2FfHtdGwSBnf6SzAHaDU&w=350&h=156&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2",
    place: "Ibiza",
  ...
  {
    image:
      "https://th.bing.com/th/id/OIP.7LCLTJFWvmRx2mLaKcERvAHaEo?w=259&h=180&c=7&r=0&o=5&pid=1.7",
    place: "Prague",
    ...
    description:
      "One of the prettiest European cities with so much to do and so much history to explore",
  },
  {
    image:
      "https://th.bing.com/th/id/OIP.NExrJiVO9f5xTScypV_q5wHaE8?w=267&h=180&c=7&r=0&o=5&pid=1.7",
    place: "New Brighton",
    ...
    description:
      "The promonade is right infront of my home and it makes for the most beautiful walks",
  }
];
